...
The qualification is having four levels; twelve Objective Tests, and three Case Study exams. 
  ...
  <div class="container">
    <div class="row" id="headingOne">
        ...
        <button class="btn btn-link collapsed col-md-12 " data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><h3 class="text-left">
          The Entry Level - Certificate in Business Accounting </h3> f107 
        </button>
